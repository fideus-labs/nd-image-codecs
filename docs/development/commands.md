...
| `uvx --from commitizen==4.17.0 cz changelog --unreleased-version=v0.2.0 --dry-run` | Preview the changelog section for the next release |
| `uvx --from commitizen==4.17.0 cz commit` | Write a Conventional Commit message interactively |
