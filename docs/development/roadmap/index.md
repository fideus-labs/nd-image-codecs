...
| **5** | The **`nd_zfp`** codec: pure-Rust ZFP (via `zfp-rs`, bit-identical to the C reference on little-endian targets) for 1D–4D, brick index, fixed-rate GPU bricks | [Phase 5 — nd_zfp](./phase-5-nd-zfp.md) |
