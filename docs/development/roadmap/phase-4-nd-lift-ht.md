...
**Depends on:** Phases 2 + 3 · **Gates:** Phase 6 · **Architecture:** [Zarr Codecs](../../architecture/zarr-codec.md),
[Byte-Range Access](../../architecture/range-access.md),
[nd_lift Transform](../../architecture/nd-transform.md)
