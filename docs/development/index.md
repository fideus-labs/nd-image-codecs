...
| --- | --- |
| [](./commands.md) | Everyday commands: build and check, test, lint and format, benchmarks, bindings, CLI smoke tests, release, and building the documentation site |
...
| --- | --- | --- |
| Roadmap | The six strictly ordered implementation phases: what to build, against which spec clauses and reference implementations, with which tests and benchmarks, and what "done" means | [](./roadmap/index.md) |

Deciding what to implement next always starts at the
[](./roadmap/index.md) — phases are strictly ordered, and a phase's
